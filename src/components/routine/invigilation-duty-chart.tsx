...
import type { DutyChart, Teacher, SchoolInfo } from '@/types';
...
export default function InvigilationDutyChart({ dutyChart, teachers, schoolInfo }: InvigilationDutyChartProps) {
