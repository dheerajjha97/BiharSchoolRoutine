...
import type { SchoolConfig, CombinedClassRule, SplitClassRule, Teacher, SubjectPriority, SubjectCategory, Unavailability, DayOfWeek } from "@/types";
...
export default function RoutineControls({
  ...
  const handleWorkingDayChange = (day: DayOfWeek, checked: boolean) => {
    ...
    // Re-sort the days to maintain a consistent order
